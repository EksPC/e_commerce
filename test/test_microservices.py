...
class TestMicroservices(unittest.TestCase):
    ...
    def test_order(self):
        ...
        print("Creating items and adding stock")
        ...
        print(f"Created item1 with ID: {item_id1} and added stock 15")

        print("Creating item2 with stock 1 (to test failure)")
        ...
        print(f"Created item2 with ID: {item_id2} and added stock 1")
        print("Adding both items to order")
        ...
        print("Checkout failed as expected due to item2 being out of stock. Verifying compensation...")
        ...
        print("Compensation successful, item1 stock is unchanged. Now testing checkout failure due to no credit...")
        ...
        print("Item2 restocked. Attempting checkout again (should fail due to no credit)...")
        ...
        print("Checkout failed as expected due to no credit. Adding credit...")
        ...
        print("Credit added. Attempting checkout again (should succeed now)...")
